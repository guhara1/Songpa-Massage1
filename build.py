...
# 검색엔진 소유확인 메타 — 값이 있을 때만 모든 페이지 <head>에 삽입된다.
_VERIFY_META = ""
if NAVER_VERIFY:
    _VERIFY_META += f'<meta name="naver-site-verification" content="{NAVER_VERIFY}">\n'
if GOOGLE_VERIFY:
    _VERIFY_META += f'<meta name="google-site-verification" content="{GOOGLE_VERIFY}">\n'
...
{robots}
{_VERIFY_META}<link rel="canonical" href="{canonical}">
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <div class="footer-cta">
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow"><span class="footer-cta-ico" aria-hidden="true">✦</span> 웹사이트 제작문의</a>
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow"><span class="footer-cta-ico" aria-hidden="true">✦</span> 제휴문의</a>
      </div>
    </div>
    <nav class="footer-col" aria-label="서비스 안내">
      ...
      <ul>
        ...
        <li><a href="/seoul/songpa-gu/">지역별 안내</a></li>
        <li><a href="/seoul/songpa-gu/station/">역세권 안내</a></li>
        <li><a href="/seoul/songpa-gu/area/">생활권 안내</a></li>
  ...
  <div class="footer-bottom">
    <div class="container footer-bottom-inner">
      ...
      <a class="footer-made" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow">웹사이트 제작·제휴문의 ↗</a>
    </div>
  </div>
</footer>
...
def build() -> None:
    ...
    for page in PAGES:
        path = page["path"]  # "" 또는 "seoul/songpa-gu/jamsil-dong/" 형태
        ...
        if desc_len > 80:
            print(f"  ⚠ DESC>{80}: ({desc_len}자) {path or '/'} — {page['desc']}")
        report.append((path or "/", chars, "noindex" if noindex else "index"))

    # sitemap.xml — 색인 허용 페이지만, lastmod 포함
    urls = "\n".join(
    ...
    # rss.xml — 네이버/색인 디스커버리용 피드(전체 색인 페이지)
    def _esc(s):
    ...
    with open(os.path.join(ROOT, "rss.xml"), "w", encoding="utf-8") as f:
        f.write(
            ...
            "<channel>\n"
            f"  <title>{_esc(BRAND)} — 송파 출장마사지·홈타이</title>\n"
            f"  <link>{base}/</link>\n"
            f'  <atom:link href="{base}/rss.xml" rel="self" type="application/rss+xml"/>\n'
            "  <description>송파구 전지역 방문 출장마사지·홈타이 지역·역세권·생활권 안내</description>\n"
    ...
    # IndexNow 키 파일 — 루트에 "<KEY>.txt" (내용도 KEY)
    if INDEXNOW_KEY:
